...
class NLP_loader(Dataset):
    def __init__(self, data_path, dataclass):
        self.dialogs = []
...
#         val_path = "/home/fiveone2521/NLP/fixed_valid.csv"
        ...
        #data.head(10)
#         data_valid = pd.read_csv(data_path, encoding='utf-8')
#         data_test = pd.read_csv(data_path, encoding='utf-8')
    ...
    #             self.dialogs.append([context[:], emo, senti])
            ...
            #print("context:",context)
                ...
                self.dialogs.append([context_speaker[:], context[:]])
    #             self.dialogs.append([context[:], emo, senti])
